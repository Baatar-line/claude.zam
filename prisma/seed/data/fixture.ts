...
export const fixtureDataset: SeedDatasetInput = {
  ...
  universities: [
    ...
    {
      key: "shutis",
      nameMn: "Шинжлэх Ухаан Технологийн Их Сургууль",
      country: "Монгол",
      city: "Улаанбаатар",
      isPublic: true,
      ...
      programs: [
        {
          key: "shutis.civil-engineering",
          nameMn: "Барилгын инженер",
          careerSlugs: ["barilgiin-injener"],
          tuitionMnt: null,
          eeshThreshold: null,
          durationYears: 4,
        },
    ...
    {
      key: "tokyo-tech",
      nameMn: "Токиогийн Технологийн Дээд Сургууль",
      country: "Япон",
      city: "Токио",
      isPublic: true,
      ...
      programs: [
        {
          key: "tokyo-tech.computer-science",
          nameMn: "Компьютерийн ухаан",
          careerSlugs: ["programm-hangamjiin-injener"],
          tuitionMnt: null,
          eeshThreshold: null,
          durationYears: 4,
          quotaNotes: "Гадаад оюутанд зориулсан бүртгэл, хэлний шаардлага тус тусдаа байдаг.",
        },
      ],
    },
  ],
